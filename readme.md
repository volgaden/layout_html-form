# HTML form
Replace `volgaden` with your Github username and copy the links to Pull Request description:
- [DEMO LINK](https://volgaden.github.io/layout_html-form/)
- [TEST REPORT LINK](https://volgaden.github.io/layout_html-form/report/html_report/)
